...
- [docs/DETAIL_PAGE_CRAWL.md](docs/DETAIL_PAGE_CRAWL.md) - **Detail-Page Crawl-Regeln pro Quelle** (Selektoren für Event-Detailseiten, Test-Button, Ampel, SSRF-Schutz)
